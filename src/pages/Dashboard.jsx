      ...
      <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        <thead className="text-xs text-gray-700 uppercase dark:bg-gray-700 dark:text-gray-400">
          <tr>
            ...
            <td className="px-6 py-3">Other Names</td>
            <td className="px-6 py-3">Age</td>
            <td className="px-6 py-3">gender</td>
            <td className="px-6 py-3">email</td>
            <td className="px-6 py-3">Member</td>
            <td className="px-6 py-3">Company/Church Name</td>
          </tr>
        </thead>
        <tbody>
            ...
            applications.map((application, index) => {
              ...
              return (
                ...
                >
                  ...
                  <td className="px-6 py-3">{surname}</td>
                  <td className="px-6 py-3"> {other_names}</td>
                  <td className="px-6 py-3">{age}</td>
                  <td className="px-6 py-3">{gender}</td>
                  <td className="px-6 py-3">{email}</td>
                  <td className="px-6 py-3">
                    <input
                      checked={membership_type === "member" ? true : false}
                    />
                  </td>
                  <td className="px-6 py-3">{company_name || church_name}</td>
                </tr>
              );
            })}
        </tbody>
